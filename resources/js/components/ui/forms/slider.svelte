<script lang="ts" module>
    ...
    import type { SliderRootProps, SliderRootPropsWithoutHTML } from 'bits-ui';

    export type SliderProps = SliderRootPropsWithoutHTML;
</script>
...
<script lang="ts">
    ...
    let {
        ...
        class: className,
        ...restProps
    }: WithoutChildrenOrChild<SliderProps & SliderRootProps> & RestProps = $props();
</script>
